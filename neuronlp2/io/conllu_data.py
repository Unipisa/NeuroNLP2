...
from neuronlp2.io.common import PAD_CHAR, PAD, PAD_POS, PAD_XPOS, PAD_TYPE, PAD_ID_CHAR, PAD_ID_TAG, PAD_ID_WORD
from neuronlp2.io.common import ROOT, END, ROOT_CHAR, ROOT_POS, ROOT_XPOS, ROOT_TYPE, END_CHAR, END_POS, END_XPOS, END_TYPE
...
def create_alphabets(alphabet_directory, train_path, data_paths=None, max_vocabulary_size=100000, embedd_dict=None,
    ...
    return word_alphabet, char_alphabet, pos_alphabet, xpos_alphabet, type_alphabet


# def read_data(source_path: str, word_alphabet: Alphabet, char_alphabet: Alphabet, pos_alphabet: Alphabet,
#               xpos_alphabet: Alphabet, type_alphabet: Alphabet,
...
#         sent = inst.sentence
#         data.append([sent.word_ids, sent.char_id_seqs, inst.pos_ids, inst.xpos_ids, inst.heads, inst.type_ids])
...
#         wids, cid_seqs, pids, xids, hids, tids = inst
#         inst_size = len(wids)
#         lengths[i] = inst_size
#         # word ids
...
#     data_tensor = {'WORD': words, 'CHAR': chars, 'POS': pos, 'XPOS': xpos, 'HEAD': heads, 'TYPE': types,
...
#                        pos_alphabet: Alphabet, xpos_alphabet: Alphabet, type_alphabet: Alphabet,
#                        max_size=None, normalize_digits=True, symbolic_root=False, symbolic_end=False):
...
#                 data[bucket_id].append([sent.word_ids, sent.char_id_seqs, inst.pos_ids, inst.xpos_ids,
#                                         inst.heads, inst.type_ids])
#                 max_len = max([len(char_seq) for char_seq in sent.char_seqs])
